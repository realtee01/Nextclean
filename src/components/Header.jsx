...
const Header = ({ onContactClick }) => {
  return (
    ...
    >
      ...
      {/* --- NAVIGATION LINKS --- */}
      {/* 'hidden' hides them on mobile. 'md:flex' shows them on Desktop */}
      ...
      <motion.button 
        ...
        whileTap={{ scale: 0.95 }}
        className="bg-slate-900 text-white px-5 py-2 md:px-6 md:py-2.5 rounded-full text-[10px] md:text-sm font-bold shadow-md uppercase tracking-widest"
      >
        Contact
      </motion.button>
    </motion.nav>
